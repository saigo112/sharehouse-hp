    ...
    <>
      ...
      <section id="join" className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h2 className="text-white text-3xl md:text-5xl font-headline font-black mb-12 leading-tight drop-shadow-md">
          ...
          {hasForm ? (
            <a
              ...
              className="inline-flex items-center gap-4 bg-secondary-container text-on-secondary-container px-12 py-6 rounded-xl font-headline font-black text-2xl hover:scale-105 transition-transform duration-300 shadow-xl group"
            >
              エントリーフォームへ進む
